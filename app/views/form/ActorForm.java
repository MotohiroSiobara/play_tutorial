...
public class ActorForm {
  ...
  public ActorForm(String id, String name, String height, String blood, String birthday, String birthplaceId) {
  	  this.id = id;
  	  this.name = name;
  	  this.height = height;
  	  this.blood = blood;
  ...
  public List<ValidationError> validate() {
  	  ...
  	  if (StringUtils.isNotEmpty(height)) {
  	  	  ...
  	  	  if (tmpH < 1 && tmpH > 200) {
  	  	  	  errors.add(new ValidationError("height", Messages.get("actor.height.range")));
  	  	  }
  	  }
